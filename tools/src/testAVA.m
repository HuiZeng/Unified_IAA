...
Size = 384;
% load(fullfile('data','AVA','vgg16',num2str(Size),'warp_fc_log-3-4PQR','net-epoch-10.mat'),'net');
% net.layers = net.layers(1:end-1);
% net = vl_simplenn_move(net,'gpu');

netStruct = load(fullfile('data','AVA','resnet50',num2str(Size),'gauss_lamda0.4_CE3.0_','net-epoch-5.mat')) ;
...
%     pred_score(i) = squeeze(gather(res(end).x));
